                    ...
                    <?php
                        ...
                        if (!$resultUserItems) {
                            ...
                            while ($row = mysqli_fetch_assoc($resultUserItems)) {
                                ...
                                echo "<td><form action='admin_page.php' method='POST'><input type='hidden' name='order_id' value='" . $row['id'] . "'><button type='submit' name='approve_btn'>Approve</button></form></td>";
                                echo "</tr>";
                            }
                        }
                        ...
                        if(isset($_POST['approve_btn']))
                        {
                            ...
                            $queryUpdateOrder = "UPDATE user_items SET approved = 1 WHERE id = $order_id";
                            $resultUpdateOrder = mysqli_query($con, $queryUpdateOrder);
